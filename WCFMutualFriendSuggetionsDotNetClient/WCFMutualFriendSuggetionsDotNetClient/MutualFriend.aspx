<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MutualFriend.aspx.cs" Inherits="WCFMutualFriendSuggetionsDotNetClient.MutualFriend" %>
...
<div style="margin-top: 15%;">
      <% if(null!= Session["MutualFriendsList"])
	    {
			foreach (var x in (User[])Session["MutualFriendsList"]) {
		       String userName = x.FirstName;
               String lastName = x.LastName; %>
    <div class="card" style="margin-top: 2%;margin-left: 20%;margin-right: 20%;">
        <div class="card-body">
          <h5 class="card-title"><a href="Profile.aspx?id=<% Response.Write(x.UserID); %>"><% Response.Write(userName); %>&nbsp;<% Response.Write(lastName); %></a></h5>
