...
{
    public partial class MutualFriend : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                User[] mutualList = proxy.GetMutualFriends(usr.UserID, FriendID);
                Session["MutualFriendsList"]= mutualList;

                //Response.Redirect("MutualFriend.aspx");
            }
        }
    }
}