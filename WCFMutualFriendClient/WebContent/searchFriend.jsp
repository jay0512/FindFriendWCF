...
<div class="wrap">
   <div class="search">
	<form action = "Home" method="GET" class="register-form" id="register-form">

      <input type="text" class="searchTerm" name="serachPattern" placeholder="What are you looking for?">
...
<div style="margin-top: 15%;">
      <% if(null!=request.getAttribute("FriendList"))
	    {
			UserWithCount[] users1 = (UserWithCount[])request.getAttribute("FriendList"); 
			for (int i = 0; i < users1.length; i++) { 
		       String userName = users1[i].getUserObj().getFirstName();
		       String lastName = users1[i].getUserObj().getLastName();
		       int FriendID = users1[i].getUserObj().getUserID();
    ...
    <% if(null!=request.getAttribute("nonFriendList"))
    	{
	    	UserWithCount[] users = (UserWithCount[])request.getAttribute("nonFriendList"); 
	   		for (int i = 0; i < users.length; i++) { 
		       String userName = users[i].getUserObj().getFirstName();
		       String lastName = users[i].getUserObj().getLastName();
		       int FriendID = users[i].getUserObj().getUserID();
